  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg border border-slate-200">
      <div className="px-4 py-3 border-b border-slate-200">
        <h2 className="font-semibold text-slate-900">Chat with Your Companion</h2>
        <p className="text-sm text-slate-500">I'm here to support you through this.</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="bg-slate-100 rounded-2xl px-4 py-3 text-slate-500">
                Thinking...
              </div>
            </div>
          )}
